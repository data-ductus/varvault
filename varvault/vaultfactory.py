...
def create_vault(keyring: Type[Keyring],
    ...
    """
    return VarVault(keyring, vault_name, *flags, vault_filename_from=vault_filename_to, vault_filename_to=vault_filename_to, remove_existing_log_file=True, **extra_keys)
...
def from_vault(keyring: Type[Keyring],
               ...
               vault_filename_from,
               *flags: VaultFlags,
               vault_filename_to=None,
               file_is_read_only=False,
               ignore_keys_not_in_keyring=False,
               remove_existing_log_file=False,
               **extra_keys) -> VarVault:
    """
